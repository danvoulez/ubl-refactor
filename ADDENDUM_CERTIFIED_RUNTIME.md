...
4. **Cartório (Seal & Registry Bridge):** publica/ancora no Registry; gerencia revogações e versões sob DIDs e kids.
...
- **Reprodução local:** qualquer verificador reproduz a decisão do Runtime (KATs + binário reprodutível).
