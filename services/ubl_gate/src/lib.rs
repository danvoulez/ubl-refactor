...
use audit::{
    audit_page, audit_table_partial, console_receipt_page, list_audit_compactions,
    list_audit_reports, list_audit_snapshots,
};
use chip::{create_chip, get_chip, get_runtime_attestation, metrics_handler, verify_chip};
use console::{
    console_events_partial, console_kpis_partial, console_mock24h_partial, console_page,
    mock24h_api,
};
...
use registry::{
    registry_kat_test, registry_page, registry_table_partial, registry_type_detail,
